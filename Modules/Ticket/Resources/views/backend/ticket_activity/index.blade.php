        ...
        @foreach ($activities as $act)
            ...
            <div class="card">
                    ...
                    <div class="modal-header">
                        <h5 class="text-value-lg">{{__('Ticket.ticketID')}} : {{ $act->ticketid }}</h5>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body ">
                        ...
                        <form action="" id="addTicket"
                            ...
                            <center>
                                <h4 for="ticketid ">{{__('Ticket.ticketID')}}</h4>

                                
                                <select class="form-control col-6 " name="ticketid" id="ticketid" required>
                                    <option value="">{{__('Ticket.Select')}} {{__('Ticket.ticketID')}}  </option>  
                                    @isset($ticketid)
                                         @foreach ($ticketid as $tec)
                                            <option value="{{ $tec->id }}">{{ $tec->id }}</option>
                                        @endforeach
                                    @endisset
                                </select>
                                <br>
